...
\end{figure} 
\footnotetext[1]{Photo from Matt Laskowski: \url{https://www.flickr.com/photos/fox-orian/1234526868} (16.11.18)}
\footnotetext[2]{Taken from: \url{http://hamamatsu.magnet.fsu.edu/articles/ccdanatomy.html} (16.11.18)}
...
\end{figure}
\footnotetext[4]{Taken from: \url{https://en.wikipedia.org/wiki/Hertzsprung–Russell_diagram} (last visited: 16.11.2018)}
...
The telescope has a parallactic mounting. After reflection by the primary (diameter = 70 cm) and secondary mirror the light reaches the camera which is cooled with liquid nitrogen and evacuated to about $p = 10^{-6}$ mbar in order to minimize thermal conduction.  \\
