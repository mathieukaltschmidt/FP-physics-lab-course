...
The goal of this computer-based experiment was to determine the invariant mass spectrum for the $Z$ boson using data acquired by the Large Hadron Collider at CERN in Geneva. For a better c
\end{abstract}
