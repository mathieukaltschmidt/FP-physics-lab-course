...
\end{align}
where $f$ describes the orbital frequency of the beams\footnote{In our case $f = 11.2$ kHz.} and the $\sigma_i$ describe the smearing of the beam in the respective direction.\\ %TODO: Include all parameters..
...
To check this, we plot counted amount of lepton candidates in the final state for our dataset. The result is presented in the following figure.
...
\missingfigure{Invariant massed from measured data and MC.}
...
\missingfigure{Stacked MC data histogram.}\label{fig:MChisto}
...
\blindtext\\
 %TODO: Discussion of errors
\blindtext %TODO: Summary
